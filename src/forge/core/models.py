...
ItemKind = Literal["agent", "rule", "skill", "bundle", "workflow", "prompt", "hook", "gh-action"]
...
ITEM_KINDS: tuple[ItemKind, ...] = ("agent", "rule", "skill", "bundle", "workflow", "prompt", "hook", "gh-action")
...
class BundleItemRef(BaseModel):
    ...
    kind: Literal["agent", "rule", "skill", "workflow", "prompt", "hook", "gh-action"]
